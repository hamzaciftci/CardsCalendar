...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-transform ease-[cubic-bezier(0.32,0.72,0,1)] data-[state=closed]:duration-[250ms] data-[state=open]:duration-[350ms] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
