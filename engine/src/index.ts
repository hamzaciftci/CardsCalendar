...
//
// SOURCE OF TRUTH: engine/src/index.ts at the project root (tests live there).
// The app copy (app/src/engine/index.ts) must stay identical: edit the root
// file first, run its tests, then copy it over the app copy verbatim.
